...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/Background/hidden_feature_ear} 
        \caption{Antihelix Overlapped with Helix}
        \label{fig:hfe1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/Background/hidden_feature_ear2} 
        \caption{Crus Antihelics Unclear, Fossa Triangularis Missing}
        \label{fig:hfe2}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/Background/hidden_feature_ear3} 
        \caption{Hard to Determine Antitragus}
        \label{fig:hfe3}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/Background/hidden_feature_ear4} 
