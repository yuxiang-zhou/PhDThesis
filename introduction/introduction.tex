...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{resources/formal_ear} 
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/hidden_feature_ear} 
        \caption{Antihelix Overlapped with Helix}
        \label{fig:hfe1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/hidden_feature_ear2} 
        \caption{Crus Antihelics Unclear, Fossa Triangularis Missing}
        \label{fig:hfe2}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/hidden_feature_ear3} 
        \caption{Hard to Determine Antitragus}
        \label{fig:hfe3}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{resources/hidden_feature_ear4} 
        \caption{Crus Antihelics Unclear, Longer Crus Helicis}
        \label{fig:hfe4}
    \end{subfigure}
