...
\begin{figure}
    ...
    \newcommand{\ofh}{0.24\columnwidth}
        \includegraphics[height=\ofh]{resources/Annotation_Correction/Suplementory_Meterial/SparseSamples/mean}
        \hfill
        \includegraphics[height=\ofh]{resources/Annotation_Correction/Suplementory_Meterial/SparseSamples/mean-0}
        \hfill
        \includegraphics[height=\ofh]{resources/Annotation_Correction/Suplementory_Meterial/SparseSamples/mean-1}
        \hfill
        \includegraphics[height=\ofh]{resources/Annotation_Correction/Suplementory_Meterial/SparseSamples/mean-2}
        \hfill
        \includegraphics[height=\ofh]{resources/Annotation_Correction/Suplementory_Meterial/SparseSamples/mean-3}
        \hfill
...
\subsubsection*{Subsampling of the Outline from Dense Correspondences}
...
\subsubsection{Dense Shape Reconstruction Ability}
